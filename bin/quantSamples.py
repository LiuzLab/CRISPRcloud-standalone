...
if system("time ./trimSeq.py {0} {1} {2} {3} {4} 24".format(fname, stat_name, agg_name, adapt_f, max_err_trim)) !=0:
  sys.exit(1)
print >> sys.stderr, "running bitap-align"
if system("time ./bitap-align {0} {1} {2} {3}".format(agg_name, lib_name, oup_name, max_err_quant)) != 0:
  sys.exit(1)
